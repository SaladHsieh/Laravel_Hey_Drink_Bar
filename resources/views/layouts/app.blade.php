...
<html lang="en">
  ...
  <body class="bg-gray-100">
    <div class="flex justify-between px-3 pt-2 pb-4">
      ...
      <div class="flex">
        @auth
          <a href="/posts" class="font-bold px-3 py-2 text-amber-500 rounded-lg hover:bg-slate-100 hover:text-amber-600">Order</a>
          <a href="/posts" class="font-bold px-3 py-2 text-amber-500 rounded-lg hover:bg-slate-100 hover:text-amber-600">View Order</a>
          <a href="" class="font-bold px-3 py-2 text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">User name</a>
          ...
          {{-- <a href="{{('logout')}}" class="font-bold px-3 py-2 text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">Logout</a> --}}
        @endauth
